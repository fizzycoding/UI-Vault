    ...
    <div className="flex flex-col justify-center items-center w-full">
      ...
      <div className="w-full flex flex-col items-center">
        <div className="w-full flex justify-center items-center gap-4 dark:bg-gradientDark bg-gradientLight sm:gap-8 flex-col min-h-60 sm:min-h-60 mb-10 min-md:min-h-80">
          <div className="font-segoeBold font-semibold text-green-500  text-sm mt-2 sm:text-lg flex  justify-center items-center gap-1 sm:gap-2 ">
            <MdOutlineRocketLaunch className="" />
            <span className=" underline font-semibold">100+ New Components</span>
            <span className=""> daily!</span>
          </div>
          <span className="sm:text-5xl text-4xl font-segoeBold font-extrabold text-center px-3 dark:text-texts-light95 text-texts max-w-4xl">
