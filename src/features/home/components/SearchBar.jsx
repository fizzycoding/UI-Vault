  ...
  return (
    <div className="relative hidden">
      <input
        type="text"
        placeholder="Search"
        className="max-sm:hidden bg-zinc-50 dark:bg-transparent py-1 dark:text-white max-sm:dark:text-texts-dark dark:focus:ring-gray-50 dark:ring-gray-700 outline-none placeholder:text-sm text-sm px-2 flex justify-center items-center ring-texts-light80 rounded placeholder:text-texts-light80 ring-1 focus:ring-1 focus:ring-primary pr-7"
      />
